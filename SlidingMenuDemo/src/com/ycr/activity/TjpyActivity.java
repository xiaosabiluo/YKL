...
public class TjpyActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    {   
		    ...
		    {  
		    	TjpyActivity.this.finish();  
		     }  
		});
		adapter = new BaseAdapter() {
			public View getView(int position, View convertView, ViewGroup parent) {
				 final UserInfo user=dataList.get(position);
				 convertView=LayoutInflater.from(TjpyActivity.this).inflate(R.layout.tjpy_item, null);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
				...
				intent.setClass(TjpyActivity.this, PyinfoActivity.class);
				TjpyActivity.this.startActivity(intent);
				finish();
			}
		});
	...
	private void recommendFriend() {
 		...
 		try {
 			...
 			json.put("request", PublicJsonParse.getPublicParam("recommendFriend"));
 		...
 		http.send(HttpRequest.HttpMethod.POST,App.service+"recommendFriend",params,
 		...
 		http.send(HttpRequest.HttpMethod.POST,App.service+"addFriend",params,
 		    new RequestCallBack<String>(){
 		        ...
 		        public void onSuccess(ResponseInfo<String> responseInfo) {
 		        	...
 		        	HttpResultList<UserInfo> result=gson.fromJson(jsonElement,typeToken);
 		        	if(result.isResult()){
 						AlertDialog.Builder builder = new Builder(TjpyActivity.this); 

...
public class MyListGView extends ListView implements OnScrollListener {
	...
	public MyListGView(Context context) {
		super(context);
		init(context);
	}

	public MyListGView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

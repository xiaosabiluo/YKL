...
public class ChooseVideosActivity extends Activity {
	List<VideoBucket> dataList;
	GridView gridView;
	VideoBucketAdapter adapter;// 自定义的适配器
	AlbumHelper helper;
	...
	private void initView() {
		...
		adapter = new VideoBucketAdapter(ChooseVideosActivity.this, dataList);
		gridView.setAdapter(adapter);
		gridView.setOnItemClickListener(new OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				Intent intent = new Intent(ChooseVideosActivity.this,VideoGridActivity.class);
				intent.putExtra(ChooseVideosActivity.EXTRA_IMAGE_LIST,(Serializable) dataList.get(position).imageList);
